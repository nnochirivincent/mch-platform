  ...
  return (
    <div className="bg-[#fcfbf9] min-h-screen space-y-4 sm:space-y-6 pb-6 overflow-hidden">
      ...
      <section className="w-full pt-0 pb-0">
        <div className="relative w-full overflow-hidden shadow-md h-[180px] sm:h-[220px] md:h-[280px]">
          <video
            autoPlay
            loop
            muted
      ...
      <div className="space-y-6 sm:space-y-8">
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12">
            <div className="relative rounded-3xl overflow-hidden shadow-lg py-5 sm:py-7 px-5 sm:px-8 border border-emerald-950/25">
              ...
              <div className="relative z-10 max-w-xl sm:max-w-2xl lg:max-w-3xl space-y-3 text-left">
                ...
                <div className="space-y-1">
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#162510] font-bold tracking-wide">
        ...
        {/* MEET TOLULOPE — OPEN (Uncontained, sitting directly on the browser background) */}
        <ScrollFade delay={100}>
          <section id="meet-founder" className="max-w-5xl mx-auto px-4 sm:px-8 lg:px-12 scroll-mt-6 text-left">
        ...
        {/* Footer Section */}
        <div className="pt-6 border-t border-[#23351a]/15 max-w-6xl mx-auto px-4 sm:px-8 lg:px-12">
          ...
          <div className="pt-4 border-t border-[#23351a]/15 flex flex-col sm:flex-row items-center justify-between text-xs text-[#384a30] font-semibold gap-2 pb-6">
