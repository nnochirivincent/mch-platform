...
export default function Collaboration() {
  return (
    <div className="bg-[#fbfbf9] min-h-screen text-[#1b2718] relative overflow-x-hidden selection:bg-[#3c5e2a] selection:text-white">
      ...
      {/* 6. MAIN FOOTER */}
      <footer className="py-10 px-4 sm:px-6 lg:px-10 bg-[#fbfbf9] border-t border-[#23351a]/10">
        <ScrollFade delay={80}>
          <div className="max-w-[90rem] mx-auto space-y-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4 pb-4">
              ...
              <div className="space-y-1 text-center lg:text-left">
                <Link to="/" className="inline-flex items-center space-x-3 group">
                  <img 
                    ...
                    alt="" 
                    aria-hidden="true"
                    className="w-6 h-6 object-contain shrink-0 mix-blend-multiply opacity-95 group-hover:scale-110 transition duration-300" 
                  />
              ...
              <div className="flex flex-wrap justify-center gap-4 text-xs uppercase tracking-wider font-extrabold text-[#28421c]">
                ...
                <Link to="/books" className="hover:text-[#1a2b13] transition">Our Books</Link>
                <Link to="/character-with-nature" className="hover:text-[#1a2b13] transition">CWN</Link>
              ...
              <div className="flex items-center space-x-2">
                <a href="#instagram" aria-label="Instagram" className="w-8 h-8 rounded-full bg-[#23351a] text-white flex items-center justify-center text-xs shadow hover:bg-[#1a2813] hover:scale-110 transition duration-300">
                ...
                <a href="#facebook" aria-label="Facebook" className="w-8 h-8 rounded-full bg-[#23351a] text-white flex items-center justify-center text-xs shadow hover:bg-[#1a2813] hover:scale-110 transition duration-300">
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                  </svg>
                </a>
                <a href="#youtube" aria-label="YouTube" className="w-8 h-8 rounded-full bg-[#23351a] text-white flex items-center justify-center text-xs shadow hover:bg-[#1a2813] hover:scale-110 transition duration-300">
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="pt-4 border-t border-[#23351a]/10 flex flex-col sm:flex-row items-center justify-between text-[11px] text-[#384a30] font-semibold gap-2">
