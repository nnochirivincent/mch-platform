...
export default function Home() {
  ...
  return (
    <div className="bg-[#fcfbf9] min-h-screen space-y-24 pb-24 overflow-hidden">
      ...
      <section className="relative px-4 sm:px-6 lg:px-12 pt-2 pb-12">
        <div className="relative max-w-7xl mx-auto rounded-3xl overflow-hidden shadow-2xl min-h-[82vh] flex items-center justify-end px-8 sm:px-12 lg:px-20 py-12">
          ...
          <div className="relative z-10 w-full max-w-4xl flex flex-col items-start justify-center text-left pl-8 sm:pl-20 lg:pl-32 pr-4 -mt-12 sm:-mt-16">
          ...
          <div className="relative z-10 space-y-12">
            ...
            <div className="w-full">
              <div className="relative min-h-[520px] flex items-center">
                ...
                <div className="relative z-10 w-full px-4 sm:px-12 lg:px-20 py-12">
                  <div className="grid lg:grid-cols-12 gap-8 items-center">
                    <div className="lg:col-span-6 lg:col-start-7 space-y-5 text-left">
                      ...
                      <div className="space-y-3 text-[#23351a] text-base leading-relaxed font-medium">
                        <p>
                        ...
                        <p className="text-sm sm:text-base text-[#2c4022]">
                      ...
                      <div className="pt-2 space-y-4">
                        <div>
                          <Link 
                            to="/about" 
                            className="inline-flex items-center gap-2 bg-[#23351a] hover:bg-[#1a2813] text-white text-xs font-bold uppercase tracking-widest px-6 py-3 rounded-xl shadow-xl transition border border-[#486337]"
                          >
                            <span>ABOUT MCH</span>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Link 
                              to="/books" 
                              className="bg-[#23351a] hover:bg-[#1a2813] text-white border border-[#355322] font-semibold px-4 py-2.5 rounded-xl transition shadow-lg flex items-center gap-1.5 text-xs"
                            >
            ...
            <div className="space-y-12 pt-2">
              ...
              <div className="text-center space-y-2 max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-5xl font-serif text-[#23351a]">
                  Stories That Open New Horizons
                </h2>
                <p className="font-serif italic text-[#4a6934] tracking-wide text-xl font-medium">
                  Discover The Weaverton Series
                </p>
                <div className="flex items-center justify-center space-x-3 text-[#658a4c] pt-1">
              ...
              <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start px-2 sm:px-4">
                ...
                <div className="grid sm:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="sm:col-span-7 space-y-3 text-left">
                    <div>
                      <h3 className="font-extrabold text-2xl text-[#23351a] font-serif">The Face in the Mountain</h3>
                      <p className="text-[#344030] text-sm sm:text-base leading-relaxed mt-2 font-light">
                    ...
                    <p className="text-xs sm:text-sm text-[#3a4834] italic leading-relaxed border-l-2 border-[#658a4c] pl-3 py-1">
                    ...
                    <div className="pt-2 space-y-1">
                      <Link 
                        to="/books" 
                        className="inline-flex items-center gap-1 text-xs font-extrabold uppercase tracking-wider text-[#345322] hover:text-[#23351a] transition"
                      >
                        DISCOVER THE BOOK <ArrowRight size={14} />
                      </Link>
                      <div>
                        <a href="#buy" className="text-xs text-[#4a6934] hover:underline font-medium">
                          Buy on Amazon →
                        </a>
                      </div>
                    </div>
                ...
                <div className="grid sm:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="sm:col-span-7 space-y-3 text-left">
                    <div>
                      <span className="text-[10px] font-bold uppercase tracking-widest text-[#23351a] bg-amber-300/90 px-2.5 py-0.5 rounded shadow-sm">COMING SOON</span>
                      <h3 className="font-extrabold text-2xl text-[#23351a] mt-1.5 font-serif">The Festival Shoes</h3>
                      <p className="text-[#344030] text-sm sm:text-base leading-relaxed mt-2 font-light">
      ...
      <ScrollFade>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl shadow-2xl border border-emerald-950/20 p-8 md:p-14 text-[#23351a]">
            ...
            <div className="relative z-20 grid md:grid-cols-12 gap-10 lg:gap-14 items-center">
              
              <div className="md:col-span-5 flex flex-col items-center">
                <div className="relative w-full max-w-sm bg-white/70 backdrop-blur-xl border border-emerald-900/15 rounded-3xl p-6 shadow-2xl group">
                  <div className="absolute -top-3 -right-3 bg-amber-400 text-emerald-950 font-extrabold text-[10px] tracking-wider uppercase px-3 py-1 rounded-full shadow-lg z-10">
                    100% Free
                  </div>
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-[#3a4834] italic text-xs md:text-sm font-serif">
              ...
              <div className="md:col-span-7 space-y-6">
                ...
                <div className="space-y-2 text-left">
                  <span className="text-amber-700 text-xs font-bold uppercase tracking-widest">Special Reader Gift</span>
                  <h2 className="text-3xl md:text-4xl font-extrabold text-[#23351a] leading-tight font-serif">
                    Continue the Adventure — It’s Free!
                  </h2>
                  <div className="h-1 w-20 bg-[#658a4c] rounded-full opacity-80 mt-2"></div>
                </div>

                <div className="space-y-2 text-left">
                  <h3 className="font-bold text-[#355322] text-sm md:text-base">
                    Explore the World of The Weaverton Series
                  </h3>
                  <p className="text-[#344030] text-xs md:text-sm leading-relaxed font-light">
                ...
                <form onSubmit={handleDownloadSubmit} className="space-y-4 text-left pt-2">
                  {submitted ? (
                    <div className="text-center py-8 space-y-3 bg-white/90 border border-emerald-900/15 p-6 rounded-2xl backdrop-blur-md shadow-lg">
                      <CheckCircle2 className="mx-auto text-emerald-600" size={48} />
                      <h4 className="font-bold text-xl text-[#23351a]">You're All Set!</h4>
                      <p className="text-sm text-[#3a4834]">Check your inbox for your download link.</p>
                    </div>
                  ) : (
                    <>
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="block text-[11px] font-bold text-[#355322] uppercase tracking-wider">
                            First Name
                          </label>
                          <input 
                            type="text" 
                            ...
                            required
                            className="w-full px-4 py-3 bg-white border border-emerald-900/15 rounded-xl text-sm text-[#23351a] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#658a4c] focus:border-transparent transition shadow-inner"
                          />
                        </div>
                      ...
                      <button 
                        type="submit"
                        className="w-full py-4 px-6 bg-[#23351a] hover:bg-[#1a2813] text-white font-extrabold text-xs md:text-sm uppercase tracking-wider rounded-xl transition duration-300 flex items-center justify-center gap-2 shadow-[0_10px_25px_rgba(35,53,26,0.2)] border border-[#486337] cursor-pointer"
                      >
                        <Download size={18} className="text-[#b8df8a]" />
                  ...
                  <p className="text-[11px] text-[#4a5944] leading-relaxed pt-1">
      ...
      <ScrollFade delay={80}>
        <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="relative overflow-hidden rounded-3xl shadow-xl border border-emerald-950/20 p-8 sm:p-12 lg:p-16 space-y-12">
            ...
            <div className="relative z-10 space-y-12">
              ...
              <div className="grid lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 text-left">
                  <div className="space-y-2">
                    <h2 className="text-3xl sm:text-5xl font-serif text-[#23351a] font-bold tracking-tight">
                  ...
                  <div className="space-y-4 text-[#23351a] text-sm sm:text-base leading-relaxed font-light">
                    <p>
                  ...
                  <div className="pt-6 border-t border-[#23351a]/10 space-y-4">
                    <h4 className="text-xs uppercase tracking-widest font-bold text-[#355322] text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 pt-2">
                      ...
                      <div className="flex flex-col items-center text-center max-w-[140px] space-y-2">
                        ...
                        <div>
                          <h5 className="font-bold text-[#23351a] text-xs uppercase tracking-wider">DISCOVER</h5>
                          <p className="text-[11px] text-gray-600 leading-tight mt-0.5">Notice and explore nature</p>
                        </div>
                      </div>

                      {/* Arrow 1 */}
                      <div className="hidden sm:flex text-[#355322] font-bold text-xl pb-6">
                        →
                      </div>
                      ...
                      <div className="flex flex-col items-center text-center max-w-[140px] space-y-2">
                        ...
                        <div>
                          <h5 className="font-bold text-[#23351a] text-xs uppercase tracking-wider">CONNECT</h5>
                          <p className="text-[11px] text-gray-600 leading-tight mt-0.5">Make connections and find meaning</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-center text-center max-w-[140px] space-y-2">
                        ...
                        <div>
                          <h5 className="font-bold text-[#23351a] text-xs uppercase tracking-wider">CREATE</h5>
                          <p className="text-[11px] text-gray-600 leading-tight mt-0.5">Bring discoveries into everyday life</p>
                        </div>
                      </div>
                  ...
                  <div className="pt-2 text-center lg:text-left">
                    <Link 
                      to="/cwn/pathways" 
                      className="inline-block bg-[#355322] hover:bg-[#2c441b] text-white font-bold text-xs uppercase tracking-widest px-8 py-3.5 rounded-xl shadow-lg transition"
                    >
              ...
              <div className="pt-8 pb-4 border-t border-b border-[#23351a]/15 text-center">
                <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm font-bold tracking-widest text-[#355322] uppercase">
                  <span>Nature</span>
                  <span className="text-[#658a4c] text-lg">•</span>
                  <span>Character</span>
                  <span className="text-[#658a4c] text-lg">•</span>
              ...
              <div className="space-y-10 pt-4">
                <div className="text-center max-w-2xl mx-auto space-y-3">
                  <h3 className="text-2xl sm:text-4xl font-serif font-extrabold text-[#23351a]">
                    Discovering Nature’s Laws
                  </h3>
                  <div className="space-y-2 text-gray-700 text-sm sm:text-base font-light leading-relaxed">
                    <p>
...
<div className="grid sm:grid-cols-2 gap-8 pt-4">
  ...
  <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200/80 flex flex-col">
    ...
    <div className="p-6 space-y-2 text-center flex-1 flex flex-col justify-between">
      ...
      <ScrollFade delay={90}>
        <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="relative overflow-hidden rounded-3xl shadow-xl border border-emerald-950/20 py-12 sm:py-16 text-center space-y-10">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-center mb-1">
                  <svg className="w-6 h-6 text-[#355322]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                  </svg>
                </div>
                <h2 className="text-3xl sm:text-5xl font-serif text-[#23351a] font-bold tracking-tight">
                ...
                <p className="font-serif italic text-[#4a6934] text-xl sm:text-2xl font-medium">
                  grows with your child
                </p>
                <div className="flex items-center justify-center space-x-3 text-[#658a4c] pt-1">
                  <div className="h-[1.5px] w-10 bg-[#658a4c]/40"></div>
...
<p className="text-base sm:text-lg text-[#1e3215] leading-relaxed max-w-3xl mx-auto font-semibold drop-shadow-sm text-center">
  ...
  inner growth in positive ways as they grow.
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-8 space-y-6 pt-2">
              
              {/* Primary Action Button */}
              <div>
                <a 
                  href="#explore-cwn" 
                  className="inline-flex items-center space-x-3 bg-[#23351a] hover:bg-[#1a2813] text-white font-sans text-xs sm:text-sm tracking-widest font-semibold uppercase px-8 py-4 rounded-xl shadow-xl transition-all duration-200 border border-[#486337]"
                >
              ...
              <div className="pt-6 border-t border-[#23351a]/10 max-w-md mx-auto space-y-3">
                <p className="text-xs sm:text-sm text-[#355322] font-medium">
                  Be the first to know when Character with Nature™ launches.
                </p>

                {notified ? (
                  <div className="bg-white/85 backdrop-blur-md border border-emerald-900/15 py-3 px-4 rounded-xl text-xs font-bold text-[#23351a] shadow">
                  ...
                  <form onSubmit={handleNotifySubmit} className="flex items-center bg-white rounded-xl shadow-inner border border-emerald-900/15 overflow-hidden p-1">
                    ...
                    <button 
                      type="submit"
                      className="bg-[#23351a] hover:bg-[#1a2813] text-white text-[11px] font-bold uppercase tracking-wider px-4 py-2.5 rounded-lg transition shrink-0 flex items-center gap-1.5 shadow"
                    >
     ...
     {/* 5. OUR COLLABORATION: BLOSSOM IN NATURE & SITE FOOTER INTEGRATED SECTION */}
      <ScrollFade delay={95}>
        <section className="relative w-full bg-[#fcf9f2] pt-12 pb-8 border-t border-emerald-950/10">
          
          {/* Main Collaboration Block mimicking the exact image layout */}
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mb-16">
            <div className="relative overflow-hidden rounded-3xl shadow-xl border border-emerald-950/20 py-10 sm:py-14 px-6 sm:px-10 lg:px-16">
              ...
              <div className="relative z-10 grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-4 text-left">
                  ...
                  <div className="pt-2">
                    <Link 
                      to="/collaborations" 
                      className="inline-flex items-center space-x-2 bg-[#23351a] hover:bg-[#1a2813] text-white font-sans text-xs tracking-widest font-bold uppercase px-6 py-3 rounded-xl shadow-lg transition-all duration-200 border border-[#486337]"
                    >
