    ...
    <div className="bg-[#fbfbf9] min-h-screen text-[#1b2718] relative overflow-x-hidden selection:bg-[#3c5e2a] selection:text-white">
          ...
          <ScrollFade delay={80}>
            <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-6 space-y-3 text-left px-2 sm:px-4">
                ...
                <h3 className="text-lg sm:text-xl font-serif font-semibold text-[#2c3e24]">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-base rounded-xl bg-white border border-[#3c5e2a]/30 focus:outline-none focus:border-[#3c5e2a] shadow-sm text-[#1b2718]"
                  />
                  ...
                  <div className="flex flex-col sm:flex-row gap-2.5">
                    <input 
                      ...
                      className="flex-1 px-4 py-3 text-base rounded-xl bg-white border border-[#3c5e2a]/30 focus:outline-none focus:border-[#3c5e2a] shadow-sm text-[#1b2718]"
                    />
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-1">
                    <a 
                      ...
                      className="inline-block bg-[#3c5e2a] hover:bg-[#2c441b] text-white font-bold text-xs uppercase tracking-wider px-5 py-3 rounded-xl shadow-md transition duration-300"
                    >
                      DOWNLOAD FREE →
                    </a>
                  </div>
      ...
      <section className="relative py-6 sm:py-8 px-4 sm:px-6 lg:px-12 overflow-hidden bg-[#eaf0e8] border-t border-[#23351a]/10 shadow-inner">
        <div className="relative z-10 max-w-xl mx-auto text-center space-y-2">
          <ScrollFade delay={80}>
            <span className="inline-block text-[#3c5e2a] text-xl mb-0.5">🍃</span>
            ...
            <div className="pt-2">
              <Link 
                to="/books" 
                className="inline-block bg-[#3c5e2a] hover:bg-[#2c441b] text-white font-extrabold text-xs uppercase tracking-widest px-6 py-3 rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
              >
                EXPLORE OUR BOOKS →
              </Link>
            </div>
